...
### 6.SPRINT BACKLOG (Sprint Refinement)
![Captura Sprint Backlog Final Trello](https://github.com/PracticasDesarrolloAgil/Practica_2/blob/master/pb_refinement.png)

### 7.SPRINT BACKLOG (fin Sprint)
